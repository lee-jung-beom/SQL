...
INSERT INTO users (userid, usernm, pass, reg_dt, alias) VALUES('leonard', '레너드', 'leonardPass', SYSDATE, '개구리');
INSERT INTO users (userid, usernm, pass, reg_dt, alias) VALUES('edward', '에드워드', 'edwardPass', SYSDATE, '애벌레');
INSERT INTO users (userid, usernm, pass, reg_dt, alias) VALUES('jessica', '제시카', 'jessicaPass', SYSDATE, '고양이');
INSERT INTO users (userid, usernm, pass, reg_dt, alias) VALUES('boss', '보스', 'bossPass', SYSDATE, '사람');
INSERT INTO users (userid, usernm, pass, reg_dt, alias) VALUES('choco', '초코', 'chocoPass', SYSDATE, '곰2');
INSERT INTO users (userid, usernm, pass, reg_dt, alias) VALUES('pangyo', '팡요', 'pangyoPass', SYSDATE, '판다');
INSERT INTO users (userid, usernm, pass, reg_dt, alias) VALUES('muzi', '무지', 'muziPass', SYSDATE, '토끼');
INSERT INTO users (userid, usernm, pass, reg_dt, alias) VALUES('con', '콘', 'conPass', SYSDATE, '악어');
INSERT INTO users (userid, usernm, pass, reg_dt, alias) VALUES('apeach', '어피치', 'apeachPass', SYSDATE, '복숭아');
INSERT INTO users (userid, usernm, pass, reg_dt, alias) VALUES('ryan', '라이언 ', 'ryanPass', SYSDATE, '사자');
commit;
